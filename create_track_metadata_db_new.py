...
# artist_name: Halle/Hughes
# artist_playmeid: -1
# artist_terms: shape = (64,)
# artist_terms_freq: shape = (64,)
# artist_terms_weight: shape = (64,)
# audio_md5: 509305a801621d64e3aa7507d2674554
# bars_confidence: shape = (196,)
# bars_start: shape = (196,)
# beats_confidence: shape = (791,)
# beats_start: shape = (791,)
## danceability: 0.0
# duration: 296.46322
# end_of_fade_in: 16.985
# energy: 0.0
# key: 7
# key_confidence: 0.685
# loudness: -32.411
# mode: 1
# mode_confidence: 0.61
# release: Much Loved Music (Vols. 1 & 2)
# release_7digitalid: 152405
# sections_confidence: shape = (15,)
# sections_start: shape = (15,)
# segments_confidence: shape = (483,)
# segments_loudness_max: shape = (483,)
# segments_loudness_max_time: shape = (483,)
# segments_loudness_start: shape = (483,)
# segments_pitches: shape = (483, 12)
# segments_start: shape = (483,)
# segments_timbre: shape = (483, 12)
# similar_artists: shape = (100,)
# song_hotttnesss: nan
# song_id: SOROXIB12A8C135F80
# start_of_fade_out: 262.792
# tatums_confidence: shape = (791,)
# tatums_start: shape = (791,)
# tempo: 165.398
# time_signature: 4
# time_signature_confidence: 0.402
# title: Valse Triste (Kuolema Op 44)
# track_7digitalid: 1592930
# track_id: TRAAAKO128F426441E
# year: 0
...
def create_db(filename):
    ...
    q += 'energy real, '
    q += 'key int, '
    q += 'key_confidence real, '

    q += 'loudness real, '
    q += 'mode int, '
    q += 'mode_confidence real, '
    q += 'song_hotttnesss real, '

    q += 'tempo real, '
    q += 'time_signature int, '
    q += 'time_signature_confidence real, '
...
def fill_from_h5(conn, h5path, verbose=0):
    ...
    q += ", " + str(key_confidence) if not np.isnan(key_confidence) else ",-1"
    ...
    q += ", " + str(mode_confidence) if not np.isnan(mode_confidence) else ",-1"
    ...
    q += ", " + str(time_signature_confidence) if not np.isnan(time_signature_confidence) else ",-1"
